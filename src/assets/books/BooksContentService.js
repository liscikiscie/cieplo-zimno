...
const books = [
    {
        ...
        shops: {
            shop1: 'http://www.empik.com/pressing-lipski-rafal,p1123059968,ksiazka-p',
            shop2: 'https://merlin.pl/pressing-lipski-tomasz/7121220/',
            shop3: 'https://www.labotiga.pl/pilka-nozna/4270-pressing.html?search_query=pressing&results=1'
        },
        shortDescription: 'Powieść z gatunku political fiction, która dotyka jednego z najbardziej wrażliwych obszarów męskiej rywalizacji. Sprawdź, czy obiecujący polski napastnik przezwycięży presję społeczną. ',
        reviews: {
    ...
    {
        id: 'futbolowaRewolucja',
        title: 'Futbolowa rewolucja',
        imgSrc: FutbolowaRewolucja,
        author: 'Jim Keoghan',
        ISBN: {
            isnb: '9788394205980',
            bookFormat: '161 x 231 mm',
            bookBinding: 'miękka',
            numberOfPages: '256',
            bookEdition: 'I',
            coverPrize: '39,90 zł'
    ...
    },
    {
        ...
        shops: {
            shop1: 'http://www.empik.com/going-to-the-metch-niciejewski-przemyslaw,p1129676916,ksiazka-p',
            shop2: 'https://merlin.pl/going-to-the-match-przemyslaw-niciejewski/7403587/',
            shop3: 'https://www.labotiga.pl/albumy-i-encyklopedie-sportowe/4157-going-to-the-match.html?search_query=going&results=9'
        },
        shortDescription: '„Going to the Match" to podróż przez wiejskie boiska, zapomniane stadiony ale również olbrzymie areny piłkarskie. To świat pełen emocji, oddania, przygnębienia i frustracji.',
        reviews: {
            author_1: 'Michał Okoński',
            text_1: 'W piłce nożnej najważniejsi nie są piłkarze i trenerzy – w piłce nożnej najważniejsi jesteśmy my, kibice. Autentyczność naszych emocji ma większą wartość niż mistrzostwa, puchary, kontrakty i transfery. Niewielu potrafi pokazać to tak dobrze, jak Niciejewski.',
            author_2: 'Rafał Stec',
            text_2: 'Ta fotograficzna podróż wiedzie przez Europę – bogatą i biedną, spektakularną i prowincjonalną – uzmysławiając, że przez piłkę nożną można obejrzeć cały świat. Niciejewski od wielu lat z aparatem w dłoni rejestruje fenomen bycia kibicem. Większość wykonanych przez niego zdjęć powstała w Polsce, Niemczech oraz Anglii, gdzie w ostatnich latach odwiedził setki stadionów ale nie widział większości bramek, które wówczas zdobyto. Skoncentrowany na trybunach, bo tylko wtedy w możliwie obiektywny sposób mógł za pomocą zdjęć opisać świat kibica.'
        }
    },
    {
        id: 'kobiety i futbol',
        title: 'Kobiety i futbol. Kompleksowo od A do Ö',
        imgSrc: KobietyIFullboll,
        author: 'Jared Burzynski',
        ISBN: {
            isnb: '9788394601096',
            bookFormat: '140 x 205 mm',
            bookBinding: 'miękka',
            numberOfPages: '208',
            bookEdition: 'I',
            coverPrize: '34,90 zł'
    ...
    },
    {
        ...
        shops: {
            shop1: 'http://www.empik.com/mistrzowskie-rozmowy-bialo-czerwoni-mundialisci-chinowski-nikodem,p1191080082,ksiazka-p',
            shop2: 'https://merlin.pl/mistrzowskie-rozmowy-bialo-czerwoni-mundialisci-nikodem-chinowski/7934119/',
            shop3: 'https://www.labotiga.pl/pilka-nozna/7753-mistrzowskie-rozmowy-bialo-czerwoni-mundialisci.html?search_query=mistrzowskie+rozmowy&results=1'
        },
        shortDescription: 'Strejlau, Masztaler, Gorgoń, Bąk, Żewłakow… To tylko niektóre nazwiska. Mistrzowskie rozmowy to szesnaście wyjątkowych rozmów z uczestnikami i obserwatorami wszystkich mundiali, na których grali biało-czerwoni.',
        reviews: {
            author_1: '',
            text_1: 'To zarówno odtworzenie ich ówczesnych gorących emocji, jak i chłodne oceny po czasie. To przywołanie wydarzeń, które dla kibiców były niedostępne, a dla sprawozdawców pozostały niezauważone. To słodkie opisy sukcesów i gorzkie bilanse niepowodzeń. \'Mistrzowskie rozmowy\' zabierają czytelnika na spacer po mundialowych boiskach, szatniach i hotelach, w których przebywały reprezentacje Polski z roczników 1938, 1974, 1978, 1982, 1986, 2002 oraz 2006. W rolę przewodników tych spacerów wcielają się uczestnicy tamtych turniejów – zarówno postacie pierwszoplanowe, jak i ci z dalszego planu. Prowadzący rozmowy i autor książki, Nikodem Chinowski, porusza sprawy przyjemne i trudne, pyta o wydarzenia publicznie znane, jak i o te do tej pory pozostające w zamkniętej szufladzie. Publikacja wzbogacona jest o znakomite grafiki, tworzące całościowy obraz polskich mundiali z lat 1938-2006.'
        }
    },
    {
        id: 'apokryf juliana',
        title: 'Apokryf Juliana',
        imgSrc: Apokryf,
        author: 'Krzysztof Bernaś',
        ISBN: {
            isnb: '9788394601065',
            bookFormat: '140 x 205 mm',
            bookBinding: 'miękka',
        ...
        shops: {
            shop1: 'http://www.empik.com/apokryf-juliana-bernas-krzysztof,p1163827815,ksiazka-p',
            shop2: 'https://merlin.pl/apokryf-juliana-bernas-krzysztof/7781893/',
            shop3: 'https://bonito.pl/k-90648462-apokryf-juliana'
        },
        shortDescription: 'Życie Juliana Żeniewskiego, młodego aspirującego pisarza, niespełnionego koszykarza i studenta warszawskiej uczelni, traci sens, po tym jak rzuca go dziewczyna. Wszystko się zmienia, gdy poznaje egzotyczną i tajemniczą studentkę aktorstwa z dalekiego kraju – Ajin.',
        reviews: {
            author_1: 'Xawery Żuławski',
            text_1: 'Niezwykła literacko, bardzo współczesna, młoda, odważna i bezkompromisowa próba otwarcia się na łączącą ponad podziałami kulturowymi i religijnymi wizję metafizycznej rzeczywistości i przenikającej całą naturę boskości, do której dotrzeć może każdy. Apokryf Juliana uzmysławia, co znaczy odpowiedzialność za życie, z którym jesteśmy połączeni dużo trwalszą więzią, niż nam się wydaje.'
        }
    },
    {
        id: 'silver stag',
        title: 'Silver Stag. Republika piratów',
        imgSrc: SilverStag,
        author: 'A.M. Rosner',
        ISBN: {
            isnb: '9788395053610',
        ...
        shops: {
            shop1: 'http://www.empik.com/silver-stag-republika-piratow-rosner-anna-m,p1191081045,ksiazka-p',
            shop2: 'https://merlin.pl/silver-stag-republika-piratow-a-m-rosner/7934116/',
            shop3: 'https://bonito.pl/k-1088347-silver-stag-tom-1-republika-piratow'
        },
        shortDescription: 'Pełna zaskakujących zwrotów akcji, brawurowa mieszanka powieści historycznej, awanturniczej, obyczajowej i przygodowej. Dla każdego, kto tęskni za przygodami, lubi zapach morza i prochu.',
        reviews: {
